<template>
    <form @submit.prevent="handleSubmit" class="select-local">
      ...
      <div class="local rental-time">
        <label for="rentalTime">Chọn thời gian thuê:</label>
        <DatePicker v-model="selectedRentalTime" :enableTime="true" format="YYYY-MM-DD HH:mm" />
      </div>
  ...
  export default {
    ...
    setup() {
      ...
      watch(selectedRentalTime, (newValue) => {
        console.log('Selected Rental Time:', newValue);
      });
      ...
      const handleSubmit = () => {
        console.log('Form Data:', {
          ...
          rentalTime: selectedRentalTime.value,
        });
