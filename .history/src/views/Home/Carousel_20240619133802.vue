    ...
    <Carousel :items-to-show="3" :wrap-around="true">
      ...
      <Slide key="slide1">
        <div class="carousel__item">
          ...
          <div  id="exampleModal" class=" modal-dialog modal-dialog-centered"></div>
        </div>
      </Slide>
      ...
      <Slide key="slide2">
        <div class="carousel__item">
          ...
          <button @click="openModal(2)" class="slide-button">
            Open Modal 2
          </button>
        </div>
      </Slide>
      ...
      <Slide key="slide3">
        <div class="carousel__item">
          ...
          <button @click="openModal(3)" class="slide-button">
            Open Modal 3
          </button>
        </div>
      </Slide>
