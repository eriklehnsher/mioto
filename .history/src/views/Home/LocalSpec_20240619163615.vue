    ...
    <div>
      ...
      >
        ...
        <div class="modal-content">
          <div class="box">
            <img v-if="modalImage" :src="modalImage" alt="Modal Image" class="modal-image" />
            <p>{{ modalContent }}</p>
          </div>
        </div>
      </div>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const openModal = (slideNumber) => {
        switch (slideNumber) {
          case 1:
            modalContent.value = " MỞ MIOTO ĐỂ NHẬN ƯU ĐÃI 100K KHI ĐẶT XE NGAY HÔM NAY";
            modalImage.value = require('@/assets/images/promos/promo1.jpg');
            break;
          case 2:
            modalContent.value = " ƯU ĐÃI 120K KHI ĐẶT XE NGAY HÔM NAY!";
            modalImage.value = require('@/assets/images/promos/promo2.jpg');
            break;
          case 3:
            modalContent.value = " DU LỊCH GIẢI NHIỆT MÙA HÈ - NHẬN NGAY ƯU ĐÃI 8%";
            modalImage.value = require('@/assets/images/promos/promo3.jpg');
            break;
          default:
            modalContent.value = "";
            modalImage.value = "";
