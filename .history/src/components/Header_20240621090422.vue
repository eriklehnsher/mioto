      ...
      <div class="actions d-flex">
        ...
        <template v-if="isLoggedIn">
          <div class="btn-group" @click="toggleDropdown" ref="dropdownRef">
            <button class="btn btn-secondary btn-lg dropdown-toggle" type="button" aria-expanded="false">
              {{ user?.username }}
            </button>
            <ul class="dropdown-menu" :class="{ show: isDropdownOpen }">
              ...
              <template v-if="user?.role === 'admin'">
                <li>
                  <router-link to="/admin-dashboard" class="dropdown-item">Dashboard Admin</router-link>
                </li>
                <li>
                  <router-link to="/manage-users" class="dropdown-item">Quản lý người dùng</router-link>
                </li>
              </template>
              <li>
